...
public class WebDataSource implements DataSource {
    ...
    public String getKvalifikacniPrace(String rokObhajoby, String katedra) {
        var uri=String.format("https://stag-demo.uhk.cz/ws/services/rest2/kvalifikacniprace/getKvalifikacniPrace?rokObhajoby=2025&outputFormat=JSON&katedra=KIKM",rokObhajoby, katedra);
        return getFromUri(uri);
    }

    @Override
    public String getTerminyZkousek2(String katedra) {
        var uri=String.format("https://stag-demo.uhk.cz/ws/services/rest2//terminy/getTerminyZkousek?katedra=KIT&outputFormat=JSON", katedra);
        return getFromUri(uri);
    }
}
